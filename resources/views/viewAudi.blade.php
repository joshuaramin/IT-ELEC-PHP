            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg" style="border: 2px solid #4d4642;">
                ...
                <form>
                    <div class="form-group" style="padding: 10px 50px 20px; display: flex; flex-direction: column; align-items: center;">
                      ...
                      <img src="{{ asset('images/about.png') }}"alt="Auditorium Image" style="width:50%; height:auto; display:block; margin:auto; filter: drop-shadow(0px 0px 4px #4d4642); padding-bottom: 20px;">
                    </div>
                    ...
                    <div class="form-group" style="padding: 10px 50px 20px;">
                      ...
                      <div>
                        <input readonly type="text" class="form-control" id="inputAudi" placeholder="Auditorium Name" value="{{ $auditorium['name'] }}" value="Medicine Auditorium" style="font-size: 17px; width: 95%; border-radius: 10px;">
                      </div>
                    </div>
                    ...
                    <div class="form-group" style="padding: 10px 50px 20px;">
                      ...
                      <div>
                        ...
                        style="font-size: 17px; width: 95%; border-radius: 10px; resize:none;">{{ $auditorium['description'] }}
                        </textarea>
                      </div>
                    </div>
