<nav x-data="{ open: false }" class="bg-white border-b border-gray-100" style="background-color: #D4BA50;">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/AudiTho-Logo.png') }}" alt="AudiTho" style="width: 140px; height: auto;">
                    </a>
                </div>
